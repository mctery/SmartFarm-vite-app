...
export function GridStackWidgetCore({ deviceId, widget, onEdit, onDelete }) {
  ...
  const getWidgetCore = () => {
    switch (widgetRef.type) {
        case 'temperature': return <TemperatureSensor deviceId={deviceId} widget={widget}/>;
        case 'humidity': return <HumiditySensor/>;
        case 'light': return <LightSensor/>;
        case 'watherlive': return <WidgetLiveWather city="Bangkok" containerRef={containerRef} />;
